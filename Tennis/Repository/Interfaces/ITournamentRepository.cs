...
namespace Tennis.Repository.Interfaces
{
    ...
    {
        Task<List<Tournament>> GetHistorialTournaments(); //Muestra el historial de todos los torneos existentes (jugados y programados)
        Task<List<Tournament>> GetHistorialTournamentsFinishes(); //Muestra el historial de todos los torneos finalizados con exito
